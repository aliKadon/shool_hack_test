...
class ColorManager {
  static Color secondary = const Color(0xFF3D6D6D);        // 3
  static Color secondaryDark = const Color(0xFF2B4C4C);    // 1       title
  static Color primary = const Color(0xFFE1BB93);    // 1       title
  static Color primaryLight = const Color(0xFFFCE6CB);    // 1       title
